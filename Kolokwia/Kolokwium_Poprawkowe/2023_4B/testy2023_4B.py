...
from szablon2023_4B import cutting as Zadanie_167
...
class testy(unittest.TestCase):
    def test_Nr001_Zadanie_167_argumenty_(self):
        self.assertEqual(Zadanie_167("student"), 2)

    def test_Nr002_Zadanie_167_argumenty_(self):
        self.assertEqual(Zadanie_167("sesja"), 3)

    def test_Nr003_Zadanie_167_argumenty_(self):
        self.assertEqual(Zadanie_167("ocena"), 4)
