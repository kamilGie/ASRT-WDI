...
def podpowiedz(nr: int):
    podpowiedzi = [
        "Policz ile jest kombinacji mozliwych tych klockow",
        "Istnieją 3 różne klocki: (1, 2, 3, 4), (1, 2, 4, 3), (1, 3, 2, 4). Reszta to ich modyfikacje.",
        "kolory w tych roznych klockach zawsze maja uniklanych sasiadow",
    ]
...
class testy(unittest.TestCase):
    ...
    def test_Nr01_Zadanie_226(self):
        ...
        Zadanie_226(tablica)
        self.assertEqual(
            tablica, [(1, 2, 3, 4), (1, 3, 4, 2), (2, 3, 1, 4), (3, 2, 4, 1)]
        )
